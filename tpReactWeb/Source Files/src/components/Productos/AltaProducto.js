...
import RubrosSubRubrosProductoSelect from "./RubrosSubRubrosProductoSelect";
...
class AltaProducto extends Component {
    ...
    render() {
        return (
            <div >
                <RubrosSubRubrosProductoSelect ref={this.rubroYSubRubroSelect} onMounted={callbacks => this.rubroYSubRubroSelectCallbacks=callbacks}/>
